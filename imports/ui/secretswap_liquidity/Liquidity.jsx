...
import Delegations from './Staking.jsx';
...
export default class SecretSwapLiquidity extends Component{
    constructor(props){
        super(props);
    ...
    render(){
        ...
        if (this.state.loading){
            ...
            return <div id="account">
                <Helmet>
                    <title>SecretSwap Liquidity | Trivium Explorer</title>
                    <meta name="description" content={"View your liquidity on SecretSwap, secured by Secret Network."} />
                </Helmet>
                <Row>
