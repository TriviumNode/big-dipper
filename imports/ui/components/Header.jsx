    ...
    render() {
        ...
        return (
            <Navbar color="primary" dark expand="lg" fixed="top" id="header">
                <NavbarBrand tag={Link} to="/"><img src="/img/trivium-wo-name.svg" className="img-fluid logo"/> <span className="d-none d-xl-inline-block">&nbsp;<b>Trivium</b> <T>navbar.explorer</T>&nbsp;</span><Badge color="secondary">{this.state.version}</Badge> </NavbarBrand>
